...
Given a human genome, the program will go though it counting every time it finds either G–C–A–T or an N which stands for Not recognized.
...
## References
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMjUwNzgyOCwtODc4Njk0MjcwLDQyND
